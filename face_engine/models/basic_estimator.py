...
class BasicEstimator(Estimator, name="basic"):
    ...
    def fit(self, embeddings, class_names, **kwargs):
        ...
        self.norms_sq = np.sum(embeddings**2, axis=1)
    ...
    def predict(self, embeddings):
        ...
        # Backward compatibility for models fitted with older versions.
        ...
        dists_sq = input_norms_sq[:, np.newaxis] + norms_sq - 2 * dot_product

        # Ensure no negative values due to floating point noise.
